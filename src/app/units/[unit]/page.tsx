    ...
    <div className="py-10 px-4 sm:px-8 max-w-4xl mx-auto text-[#222] bg-white font-sans leading-relaxed">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
          {/* 🏹 Unit Type */}
          <div className="bg-white p-4 sm:p-6 rounded-xl shadow-sm border border-gray-200 flex items-start gap-3 sm:gap-4 flex-1">
      ...
      <div className="mt-8 sm:mt-12 p-4 sm:p-6 bg-white rounded-xl shadow-sm border border-gray-200">
        <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2 sm:mb-3">🏛 Civilizations</h2>
        <ul className="list-disc text-lg sm:text-lg">
          {unitData.civilizations.map((civ: string) => (
            <p className="text-2xl pl-10 sm:text-md" key={civ}>
              <Link href={`/civilizations/${slugify(civ)}`} className="text-2xl sm:text-md text-blue-600 hover:underline">
                {civ}
              </Link>
            </p>
          ))}
      ...
      {/* 📜 Historical Context */}
      <div className="mt-8 sm:mt-12 p-4 sm:p-6 bg-white rounded-xl shadow-sm border border-gray-200">
        <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2 sm:mb-3">📜 Historical Context</h2>
        <p className="text-lg sm:text-md text-gray-700">{unitData.historical_context}</p>
      </div>

      {/* 🗺️ Strategies */}
      <div className="mt-8 sm:mt-12 p-4 sm:p-6 bg-white rounded-xl shadow-sm border border-gray-200">
        <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2 sm:mb-3">🗺️ Strategies</h2>
